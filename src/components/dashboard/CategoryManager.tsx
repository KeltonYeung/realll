      ...
      {(isCreating || editing) && (
        <div className="bg-white p-6 shadow-sm">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-gray-700 mb-2">分類名稱</label>
              <input
                type="text"
                value={formData.name}
      ...
      <div className="bg-white shadow-sm">
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              <th className="px-6 py-3 text-left text-sm font-medium text-gray-900">名稱</th>
              <th className="px-6 py-3 text-left text-sm font-medium text-gray-900">描述</th>
